...
public class NCNEXUS38MergeVCWorkflow extends AbstractSequencingWorkflow {
    ...
    public Graph<CondorJob, CondorJobEdge> createGraph() throws WorkflowException {
        ...
        try {
            ...
            // // new job
            // CondorJobBuilder builder = WorkflowJobFactory.createJob(++count, PicardMergeSAMCLI.class,
            ...
            // File picardMarkDuplicatesMetrics = new File(subjectDirectory, picardMarkDuplicatesOutput.getName().replace(".bam",
            // ".metrics"));
            ...
            //
            // // new job
            // builder = SequencingWorkflowJobFactory.createJob(++count, PicardCollectHsMetricsCLI.class,
            // attempt.getId()).siteName(siteName);
            ...
            //
            // // new job
            // builder = SequencingWorkflowJobFactory.createJob(++count, SortAndRemoveDuplicatesCLI.class,
            // attempt.getId()).siteName(siteName);
            ...
            // new job
            CondorJobBuilder builder = SequencingWorkflowJobFactory.createJob(++count, GATKVariantAnnotatorCLI.class, attempt.getId())
                    .siteName(siteName);
